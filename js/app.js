...
//"This" is the joe object parameters.

// 2. What is "this" when joe.scopeArrow() is invoked?
//With arrow functions the "this" keyword always represents the object that defined the arrow function.

// 3. Explain why "this" is different when an arrow function is used?.
//In short, with arrow functions there are no binding of "this", "this" represents the owner of the function.
//In regular functions the "this" keyword represented the object that called the function, which could be the results.